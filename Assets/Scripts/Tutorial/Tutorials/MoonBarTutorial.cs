...
#else
        AddChecklistItem("Hold [A button] to increase movement speed", 0, Group0, true, "Both abilities use the moon meter around your crosshair. It flashes when the abilities are on cooldown.");
